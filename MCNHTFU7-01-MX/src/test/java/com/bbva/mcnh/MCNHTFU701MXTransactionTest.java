...
/**
 * Test for transaction MCNHTFU701MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MCNHTFU701MXTest.xml" })
public class MCNHTFU701MXTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(MCNHTFU701MXTransactionTest.class);

	@Autowired
	private MCNHTFU701MXTransaction transaction;
