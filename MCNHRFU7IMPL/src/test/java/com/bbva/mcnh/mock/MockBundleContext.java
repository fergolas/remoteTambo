...
public class MockBundleContext implements BundleContext,
	...
	public Bundle getBundle() {
		...
		Mockito.when(mockBundle.getSymbolicName()).thenReturn("MCNHRFU7IMPL-1.0.0");
		Mockito.when(mockBundle.getVersion()).thenReturn(new Version("1.0.0"));
		return mockBundle;
	}
